  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved corporation as @corporation" do
        ...
        post :create, {:corporation => { "name" => "invalid value" }}, valid_session
        assigns(:corporation).should be_a_new(Corporation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested corporation" do
        ...
        Corporation.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => corporation.to_param, :corporation => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the corporation as @corporation" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Corporation.any_instance.stub(:save).and_return(false)
        put :update, {:id => corporation.to_param, :corporation => { "name" => "invalid value" }}, valid_session
        assigns(:corporation).should eq(corporation)
      end
